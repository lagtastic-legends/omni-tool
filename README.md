...
<p align="center">
  <a href="https://github.com/lagtastic-legends/omni-tool/releases/tag/v2.9.0">
    <img src="https://img.shields.io/github/v/release/lagtastic-legends/omni-tool?style=for-the-badge&color=8B5CF6&label=Latest%20Release%20v2.9.0" alt="Release" />
  </a>
  ...
  <a href="https://github.com/lagtastic-legends/omni-tool/actions">
    <img src="https://img.shields.io/badge/CI%2FCD-Passing-success?style=for-the-badge&logo=githubactions&logoColor=white" alt="CI Status" />
  </a>
  <a href="LICENSE">
...
| :--- | :--- | :--- |
| **🌐 Web App** | [**omni-tool-two.vercel.app**](https://omni-tool-two.vercel.app) | Live PWA with zero install required. Runs instantly in any modern desktop and mobile browser. |
| **📦 GitHub Releases** | [**v2.9.0 Release Notes & Assets**](https://github.com/lagtastic-legends/omni-tool/releases/tag/v2.9.0) | Full release artifacts, offline WASM engine, and security release notes. |
| **📱 Android APK (Signed Release)** | [**Download omni-tool-v2.8.1-release.apk**](https://github.com/lagtastic-legends/omni-tool/releases/download/v2.8.1/omni-tool-v2.8.1-release.apk) | Production signed APK (24.38 MB) optimized for phones, foldables, flips, and tablets. |
| **🛠️ Android APK (Development Debug)** | [**Download omni-tool-v2.8.1-debug.apk**](https://github.com/lagtastic-legends/omni-tool/releases/download/v2.8.1/omni-tool-v2.8.1-debug.apk) | Debug build (36.53 MB) with remote Chrome WebView debugging enabled for developers. |
